...
namespace BatchBot.BotModules
{
    ...
    {
        /// <summary>
        /// A sub-class of the BatchAdmin Module, used for Role based commands
        /// </summary>
        /// <seealso cref="Discord.Commands.ModuleBase{Discord.Commands.SocketCommandContext}" />
        /// <autogeneratedoc />
                ...
                for (int user = 0; user < Context.Guild.MemberCount; user++)
                {
                    ...
                    foreach (var item in roles)
                    {
                        if (item == role.Id)
                        {
                            ...
                            await Context.User.SendMessageAsync($"{userArray[user].Discriminator} was about to be kicked! Good thing debug builds exist!");
                            break;
                        }
                    }
                }
